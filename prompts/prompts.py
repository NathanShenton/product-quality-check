...
PROMPT_OPTIONS = {
	...
	"AUDIT: Free‑From Claim Check": {
		"prompt": (
	    	"SYSTEM MESSAGE:\n"
	    	"You are a JSON‑producing assistant. You only report real, proven violations based strictly on the constants below. "
	    	"No extra text, no disclaimers—just valid JSON.\n\n"
	
		    "CONSTANTS (do not modify):\n"
	    	"{\n"
		    "  \"claim_to_root\": {\n"
		    "    \"Gluten Free\": \"Gluten\",   \"Dairy Free\": \"Dairy\",   \"Sugar Free\": \"Sugar\",\n"
		    "    \"Celery Free\": \"Celery\",   \"Cereal Free\": \"Cereal\", \"Crustaceans Free\": \"Crustaceans\",\n"
		    "    \"Egg Free\": \"Egg\",         \"Fish Free\": \"Fish\",    \"Lupin Free\": \"Lupin\",\n"
		    "    \"Milk Free\": \"Milk\",       \"Mollusc Free\": \"Mollusc\",\"Mustard Free\": \"Mustard\",\n"
		    "    \"Nuts Free\": \"Nuts\",       \"Peanut Free\": \"Peanut\", \"Sesame Free\": \"Sesame\",\n"
		    "    \"Soya Free\": \"Soya\",       \"Sulphites Free\": \"Sulphites\", \"Wheat Free\": \"Wheat\",\n"
		    "    \"Kiwi Free\": \"Kiwi\"\n"
		    "  },\n"
		    "  \"synonyms\": {\n"
		    "    \"Gluten\": [\"wheat\", \"rye\", \"barley\", \"oat\", \"spelt\", \"farro\", \"kamut\", \"durum\", \"semolina\", \"bulgur\", \"triticale\", \"einkorn\", \"emmer\", \"graham\", \"seitan\"],\n"
		    "    \"Dairy\": [\"milk\", \"milk powder\", \"whey\", \"casein\", \"lactose\", \"butter\", \"cream\", \"cheese\", \"yogurt\", \"ghee\", \"curds\", \"caseinate\", \"caseinates\", \"lactalbumin\", \"lactoglobulin\", \"milk solids\", \"nougat\"],\n"
		    ...
		    "    \"Egg\": [\"egg\", \"egg white\", \"egg yolk\", \"albumen\", \"ovum\", \"lysozyme\", \"ovalbumin\"],\n"
		    "    \"Fish\": [\"fish\", \"tuna\", \"salmon\", \"cod\", \"haddock\", \"trout\", \"anchovy\", \"sardine\", \"mackerel\", \"pollock\", \"surimi\", \"bonito\", \"dashi\", \"roe\"],\n"
		    "    \"Lupin\": [\"lupin\"],\n"
		    "    \"Milk\": [\"milk\", \"milk powder\", \"whey\", \"casein\", \"lactose\", \"butter\", \"cream\", \"cheese\", \"yogurt\", \"ghee\", \"curds\"],\n"
		    "    \"Mollusc\": [\"mollusc\", \"mussel\", \"clam\", \"oyster\", \"scallop\", \"octopus\", \"squid\"],\n"
		    "    \"Mustard\": [\"mustard\", \"sinapis alba\", \"brassica juncea\", \"mustard seed\", \"mustard flour\"],\n"
		    "    \"Nuts\": [\"almond\", \"hazelnut\", \"walnut\", \"cashew\", \"pecan\", \"brazil nut\", \"pistachio\", \"macadamia\", \"nut oil\", \"nut butter\", \"praline\", \"marzipan\"],\n"
		    ...
		    "1. **Prepare data**\n"
		    "   – Strip all HTML from full_ingredients and warning_info and convert both to lowercase.\n"
		    "   – Tokenise on any non‑letter character. Hyphens split words.\n\n"
		    "2. **Filter claims**\n"
		    "   – Split diet_info by comma, trim, and keep only those present (case‑insensitive) in claim_to_root.\n\n"
		    "3. **Match algorithm (STRICT)**\n"
		    "   For each retained claim C (in original order):\n"
		    "     a. root = claim_to_root[C]\n"
		    "     b. For each phrase S in synonyms[root]:\n"
		    "        • Build tokens for S the same way (hyphens→split).\n"
		    "        • Single‑word S → match if that exact token (or token + 's') appears.\n"
		    "        • Multi‑word S → match if all tokens appear **consecutively**.\n"
		    "     c. If ANY S matches, record:\n"
		    "        – violated_claims += C\n"
		    "        – debug_matches += \"Confirmed violation for '<C>': <field> contains '<S>'\" (use first matching S and the field name where found).\n"
		    "     d. **DO NOT look at synonyms from any other root.**\n\n"
		    "4. **Validation (must pass or output is invalid)**\n"
		    "   – Each debug message’s <S> must be EXACTLY one of synonyms[root] (case‑insensitive, ignoring plural 's').\n"
		    "   – violated_claims and debug_matches must be 1‑to‑1 aligned.\n\n"
		    "5. **Output ONLY this JSON—no extra keys, no prose**\n"
		    "{\n"
		    "  \"violated_claims\": \"\",\n"
		    "  \"debug_matches\": []\n"
		    "}\n"
		    "Populate the values per the rules above."
		),
		"recommended_model": "gpt-4.1-mini",
		"description": "Deterministic free‑from audit with strict token‑level synonym matching and cross‑root leak protection."
		},
