...
PROMPT_OPTIONS = {
    ...
    "COMPLETE: FNV Line-by-Line Estimator": {
        "prompt": (
            ...
            "(only BEFORE you copy the first numeric % into certain_fnv)\n"
            "    1st eligible FNV → +40 %.\n"
            "    2nd → +25 %.\n"
            ...
            "    Stop assigning presumptive the moment a valid FNV % is copied.\n\n"
            ...
            "    2. If certain_fnv > 0 then presumptive_fnv MUST be 0, **unless** some FNV items "
            "appear *before* the first copied numeric % (then RULE 2 still applies).\n"
