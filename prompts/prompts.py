...
PROMPT_OPTIONS = {
    ...
    "AUDIT: Free-From Claim Check": {
        "prompt": (
            ...
            "{ \"violated_claims\": \"\", \"debug_matches\": [] }\n\n"

            "INPUT FIELDS (runtime):\n"
            "  diet_info         - string (comma-separated claims)\n"
            ...
            "{\n"
            "  \"claim_to_synonyms\": {\n"
            "    \"Gluten Free\": [\"wheat\", \"rye\", \"barley\", \"oat\", \"spelt\", \"farro\", \"kamut\", \"durum\", \"semolina\", \"bulgur\", \"triticale\", \"einkorn\", \"emmer\", \"graham\", \"seitan\"],\n"
            "    \"Dairy Free\":  [\"milk\", \"milk powder\", \"whey\", \"casein\", \"lactose\", \"butter\", \"cream\", \"cheese\", \"yogurt\", \"ghee\", \"curds\", \"caseinate\", \"caseinates\", \"lactalbumin\", \"lactoglobulin\", \"milk solids\", \"nougat\"],\n"
            "    \"Sugar Free\":  [\"sugar\", \"sucrose\", \"glucose\", \"dextrose\", \"fructose\", \"agave syrup\", \"cane sugar\", \"honey\", \"maltose\", \"molasses\", \"brown sugar\", \"invert sugar\", \"corn syrup\", \"high fructose corn syrup\", \"hfcs\", \"malt syrup\", \"maple syrup\", \"treacle\", \"panela\", \"rapadura\"],\n"
            "    \"Celery Free\": [\"celery\", \"celeriac\", \"celery root\", \"celery salt\", \"apium graveolens\"],\n"
            "    \"Cereal Free\": [\"cereal\", \"cereals\"],\n"
            "    \"Crustaceans Free\": [\"crab\", \"lobster\", \"shrimp\", \"prawn\", \"crayfish\", \"krill\"],\n"
            "    \"Egg Free\": [\"egg\", \"egg white\", \"egg yolk\", \"albumen\", \"ovum\", \"lysozyme\", \"ovalbumin\"],\n"
            "    \"Fish Free\": [\"fish\", \"tuna\", \"salmon\", \"cod\", \"haddock\", \"trout\", \"anchovy\", \"sardine\", \"mackerel\", \"pollock\", \"surimi\", \"bonito\", \"dashi\", \"roe\"],\n"
            "    \"Lupin Free\": [\"lupin\"],\n"
            "    \"Milk Free\": [\"milk\", \"milk powder\", \"whey\", \"casein\", \"lactose\", \"butter\", \"cream\", \"cheese\", \"yogurt\", \"ghee\", \"curds\"],\n"
            "    \"Mollusc Free\": [\"mollusc\", \"mussel\", \"clam\", \"oyster\", \"scallop\", \"octopus\", \"squid\"],\n"
            "    \"Mustard Free\": [\"mustard\", \"sinapis alba\", \"brassica juncea\", \"mustard seed\", \"mustard flour\"],\n"
            "    \"Nuts Free\": [\"almond\", \"hazelnut\", \"walnut\", \"cashew\", \"pecan\", \"brazil nut\", \"pistachio\", \"macadamia\", \"nut oil\", \"nut butter\", \"praline\", \"marzipan\"],\n"
            "    \"Peanut Free\": [\"peanut\", \"peanut oil\", \"arachis oil\"],\n"
            "    \"Sesame Free\": [\"sesame\", \"tahini\", \"gingelly\", \"benne seed\"],\n"
            "    \"Soya Free\": [\"soy\", \"soya\", \"soja\", \"soybean\", \"soy lecithin\", \"soy sauce\", \"tempeh\", \"edamame\", \"tofu\", \"natto\"],\n"
            "    \"Sulphites Free\": [\"sulphites\", \"so2\", \"sulfur dioxide\", \"metabisulfite\", \"bisulfite\", \"e220\", \"e221\", \"e222\", \"e223\", \"e224\", \"e225\", \"e226\", \"e227\", \"e228\"],\n"
            "    \"Wheat Free\": [\"wheat\", \"spelt\", \"farro\", \"kamut\", \"durum\", \"semolina\", \"bulgur\", \"triticale\", \"einkorn\", \"emmer\", \"graham\", \"seitan\"],\n"
            "    \"Kiwi Free\": [\"kiwi\", \"chinese gooseberry\"]\n"
            "  }\n"
            "}\n\n"

            "STEP 1 - NORMALISE TEXT:\n"
            "  - Strip HTML tags from full_ingredients and warning_info.\n"
            "  - Convert both strings to lowercase.\n\n"

            "STEP 2 - EXTRACT CLAIMS:\n"
            "  - Split diet_info on commas, trim whitespace, keep only those keys present in claim_to_synonyms (case-insensitive compare).\n\n"

            "STEP 3 - CLAIM-BY-CLAIM CHECK (loop):\n"
            "  For each retained claim **in original order** do:\n"
            "    a. Let LIST = claim_to_synonyms[claim] (exact list above).\n"
            "    b. Search the normalised full_ingredients and warning_info for ANY phrase in LIST using these rules:\n"
            "        - Whole-word match (\\b...\\b).\n"
            "        - Allow one trailing 's'.\n"
            "        - Multi-word phrases must appear **consecutively**.\n"
            "    c. If a phrase matches, record the claim as violated and capture:\n"
            "        matched_field   = full_ingredients | warning_info\n"
            "        matched_phrase  = the exact phrase from LIST that triggered.\n\n"

            "STEP 4 - VALIDATE YOURSELF:\n"
            "  - If matched_phrase is NOT literally in LIST, the claim is NOT a violation (discard it).\n"
            "  - Do not borrow phrases from any other list—even if you think they are related.\n\n"

            "STEP 5 - BUILD OUTPUT ARRAYS:\n"
            "  violated_claims  = comma-separated violated claims (same order as diet_info input).\n"
            "  debug_matches    = array of strings in the exact template:\n"
            "    \"Confirmed violation for '<Claim>': <matched_field> contains '<matched_phrase>'\"\n\n"

            "STEP 6 - INTERNAL SELF-CHECK (MANDATORY):\n"
            "  - Create an internal block delimited by <<< and >>>.\n"
            "  - Inside, recompute the entire logic independently under variables R2_violated, R2_debug.\n"
            "  - If R2_... differs from your first result, REPLACE your first result with R2_.\n"
            "  - Delete the <<< ... >>> block before you respond.\n\n"

            "STEP 7 - OUTPUT (strict):\n"
            "{\n"
            "  \"violated_claims\": \"\",\n"
            "  \"debug_matches\": []\n"
            "}\n"
            "Populate the two values per the rules above and output nothing else."
        ),
        "recommended_model": "gpt-4.1-mini",
        "description": "Mission-critical free-from auditor with per-claim isolation, synonym whitelisting, and self-validation."
},
