...
PROMPT_OPTIONS = {
    ...
    "Food Supplement Compliance Check": {
        "prompt": (
            ...
            "  2. If it is a food supplement, ensure the marketing/sell copy, directions, and warnings include all required UK food supplement labeling elements:\n"
            ...
            "    }\n"
            "}\n\n"
            "If \"is_food_supplement\" is false, set \"justification\" accordingly and omit or leave \"compliance_check\" empty.\n"
            "No disclaimers or extra commentary—JSON ONLY.\n\n"
            "USER MESSAGE:\n"
