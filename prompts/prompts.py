...
PROMPT_OPTIONS = {
    ...
    "Allergen Bold Check": {
        "prompt": (
            ...
            "   - Each allergen synonym must be evaluated as a standalone word, not as part of compound phrases like \"almond and hazelnut.\" If \"almond\" and \"hazelnut\" are individually bolded, it is valid — even if they are joined by unbolded words like \"and\".\n\n"
            "4) Do not treat a phrase as unbolded if each allergen word is properly wrapped in bold tags, even if they are joined by unbolded connectors like commas, \"and\", or punctuation.\n"
            "   If a word is partially bolded (e.g., only part of the word is within <strong>), then treat it as unbolded.\n\n"
            ...
            "  \"debug_matches\": [\n"
            "    \"Matched 'milk': found 'milk powder' — appears unbolded in: 'dried milk powder, sugar, cocoa'\",\n"
            "    \"Matched 'wheat': found 'wheat flour' — appears unbolded in: 'wheat flour, water, salt'\"\n"
            "  ]\n"
            "}\n\n"
