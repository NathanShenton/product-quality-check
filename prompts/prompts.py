...
PROMPT_OPTIONS = {
    ...
    "Prohibited Marketplace Compliance Checker": {
        "prompt": (
            ...
            "Flag `prohibited_flag` = \"Yes\" ONLY when the match is clear and specific. "
            "If uncertain, respond \"No\" / \"None\".\n\n"
    
            "–––––  MEDICINAL PRODUCT LOGIC  –––––\n"
            "Flag as \"Medicinal Product\" **only if at least ONE** of these is true:\n"
            ...
            "Do **NOT** flag as medicinal when ONLY evidence is:\n"
            ...
            "• **Traditional or historical framing** (e.g. “used for 400 years”, “Ayurvedic herb”, “traditional support”).\n"
            ...
            "• Common supplement ingredients (magnesium, vitamin C, turmeric, ashwagandha, sea moss, psyllium, etc.) without disease claims.\n\n"
    
            "–––––  ADDITIONAL CATEGORY RULES  –––––\n"
            "AGE-RESTRICTED BLADES\n"
            "• Flag “Age Restricted: Knives or Blades” if any field contains: knife, knives, blade, razor, "
            "scalpel, machete, axe, cleaver, chopper, box-cutter, stanley, sword, katana, kukri, sharpened, "
            "with inch/cm length (e.g. “5\" blade”).\n\n"
            ...
            "COUNTERFEIT OR IP VIOLATIONS\n"
            "• Flag if wording like replica, inspired by, type, dupe, “smells like”, “compatible with <famous brand>” "
            "appears alongside a well-known trade mark (e.g. Chanel No. 5, Nike, Apple). "
            "• Genuine parallel-import products with original branding are NOT counterfeit—only flag the explicit replica/inspired cases.\n\n"
    
            "PRODUCT DATA:\n"
            "{{product_data}}\n"
        ),
        "recommended_model": "gpt-4o-mini",
        "description": "Prohibited-item checker with refined medicinal rules, EFSA safe-harbour list, and specific tests for blades, infant food, and replica IP."
    },
    "Food Supplement Compliance Check": {
        "prompt": (
            "SYSTEM MESSAGE:\n"
            "You are a JSON-producing assistant for high-criticality compliance checking. Your task is to review all available data for a single SKU (which may include ingredients, descriptions, nutritionals, sell copy, warnings, directions, quantity, and any other fields) and:\n"
            "  1. Determine whether the product is a food supplement based on the holistic context of its data.\n"
            "  2. If it is a food supplement, verify that its labeling (e.g., sell copy, directions, warnings) includes all mandatory UK food supplement statements:\n"
            ...
            "  3. If it is not a food supplement, report that accordingly without performing the compliance check.\n\n"
            "Return JSON ONLY in exactly this format:\n"
            "{\n"
            "    \"is_food_supplement\": true | false,\n"
            "    \"justification\": \"<brief rationale based on the combined data>\",\n"
            "    \"compliance_check\": {\n"
            ...
            "    }\n"
            "}\n\n"
            "If \"is_food_supplement\" is false, set \"justification\" accordingly and omit \"compliance_check\" entirely (or leave its fields empty).\n"
            "No disclaimers or extra commentary—JSON ONLY.\n\n"
            "USER MESSAGE:\n"
