...
PROMPT_OPTIONS = {
    ...
    "Prohibited Marketplace Compliance Checker": {
        "prompt": (
            ...
            "Do **NOT** flag as medicinal when ANY of these are the ONLY evidence:\n"
            "• **Permitted EFSA-style structure-function claims**, e.g.:\n"
            ...
            "• **Traditional or historical framing** only (e.g. “used for 400 years”, “Ayurvedic herb”, "
            "“traditional support”).\n"
            "• Generic wellbeing language: “balance”, “vitality”, “overall health”, “adaptogen”.\n"
            "• Standard food-supplement disclaimers: “consult your GP”, “not suitable for children”, "
            "pregnancy/medication cautions.\n"
            "• Common supplement ingredients (magnesium, vitamin C, turmeric, ashwagandha, sea moss, "
            "psyllium, etc.) **without** therapeutic disease claims.\n\n"
    
            "PRODUCT DATA:\n"
            "{{product_data}}\n"
        ),
        "recommended_model": "gpt-4o-mini",
        "description": "Prohibited-item checker with refined medicinal-claim rules and EFSA safe-harbour list to minimise false positives."
    },
