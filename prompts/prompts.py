...
PROMPT_OPTIONS = {
    ...
    "COMPLETE: CLEAN: Claim Removal & Readability-Preserving HTML Rewrite": {
        "prompt": (
            ...
            "        {\"char\": \"®\", \"replacement\": \" (R)\"}\n"
            "      ],\n"
            "      \"notes\": \"<brief note on any other replacements performed or 'none'>\"\n"
            "    },\n"
            "    \"detections\": [\n"
            "      {\n"
            "        \"claim_id\": \"<claim_id>\",\n"
            ...
            "        \"occurrences\": [\n"
            "          {\n"
            "            \"html_context\": \"paragraph|list_item|heading|other\",\n"
            "            \"original_sentence\": \"<the full sentence or list item text BEFORE change>\",\n"
            "            \"decision\": \"remove_phrase|remove_sentence|remove_element\",\n"
            "            \"reason\": \"<why this decision preserves natural readability>\",\n"
            "            \"surgical_rules\": [\n"
            "              \"Removed surrounding filler (e.g., 'for') if it caused a dangling fragment\",\n"
            "              \"Removed preceding/trailing dash if left hanging\",\n"
            "              \"Fixed punctuation and spaces\"\n"
            "            ],\n"
            "            \"revised_sentence\": \"<AFTER change (or empty if sentence/element removed)>\"\n"
            "          }\n"
            "        ],\n"
            "        \"not_found\": false\n"
            "      }\n"
            ...
            "  },\n"
            "  \"result\": {\n"
            "    \"repaired_html\": \"<HTML after tag balancing/whitespace tidy but BEFORE claim removals>\",\n"
            "    \"final_html\": \"<HTML AFTER removals and ASCII sanitisation>\",\n"
            ...
            "    },\n"
            "    \"explanations\": [\n"
            "      \"<plain-English summary that EXACTLY explains decisions and why readability is preserved>\"\n"
            "    ],\n"
            "    \"status\": \"Pass|Fail\"\n"
            "  },\n"
        ...
        "recommended_model": "gpt-4.1-mini",
        "description": "Removes one or more claims from HTML product copy while preserving readability and structure. Self-explains each decision, repairs HTML, and outputs ASCII-only final HTML with validation checks."
    },
