...
PROMPT_OPTIONS = {
    ...
    "NPM & HFSS Classification": {
        "prompt": (
            ...
            "4. If A-points ≥ 11 and FVN points < 5 (or missing), set protein points = 0.\n"
            "5. Produce two NPM scores:\n"
            ...
            "6. Determine `hfss_legislation` (“In Scope” or “Out of Scope”) based on whether it’s a food or drink and the per-100 thresholds.\n"
            "7. Assign `hfss_category` (“Less healthy” vs “Not HFSS”) per UK rules.\n"
            "8. In `debug_notes`, clearly state which data were used, which were missing or ambiguous, and how you handled each case.\n"
            "\n"
