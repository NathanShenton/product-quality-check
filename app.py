...
PROMPT_OPTIONS = {
    ...
    "Legal Category Classifier": {
            "prompt": (
                ...
                "licensed medicine – choose \\\"GSL Medicine\\\" unless the pack or description specifies another "
                "class (P, POM, etc.).\\n"
                "• Distinguish \\\"Food Supplement (Liquid)\\\" vs \\\"Food Supplement (Solid)\\\" by keywords in "
                "lexmark_pack_size: \\\"ml\\\", \\\"l\\\", \\\"liquid\\\", \\\"syrup\\\" → Liquid; "
